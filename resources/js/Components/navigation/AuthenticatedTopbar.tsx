      ...
      <div className="flex w-full flex-col gap-2 px-3 py-2.5 sm:gap-3 sm:px-4 sm:py-3 md:flex-row md:items-center md:justify-between md:px-6 md:py-4">
        ...
        <div className="flex items-center justify-end gap-2 sm:gap-3">
          ...
          >
            ...
            {notificationsCount > 0 ? (
              <span className="absolute right-0 top-0 inline-flex h-4 min-w-[1rem] items-center justify-center rounded-full bg-error px-1 text-[10px] font-semibold leading-none text-white sm:right-0.5 sm:top-0.5">
