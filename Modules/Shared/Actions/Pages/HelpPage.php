...
class HelpPage
{
    ...
    public function handle(): Response
    {
        return Inertia::render('Help/Index', [
            'greeting' => 'Вітаю! Я КомуШІшка — ваш AI-помічник у Комуналці. Запитайте мене про внесення показань, лічильники, провайдерів чи адреси — я підкажу крок за кроком і відкрию відповідний розділ документації.',
            'suggestedChips' => [
                'Як внести показання?',
