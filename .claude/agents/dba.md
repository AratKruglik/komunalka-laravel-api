...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('payments', function (Blueprint $table): void {
            ...
            $table->index(['mentor_program_id', 'created_at']);
        });
    }
...
```php
// Always use query()
MentorProgram::query()->where('status', 'active')->get();

// Always use getKey()
$program->getKey(); // NOT $program->id
...
| Index strategy | API endpoints | Backup strategy |
