...
- Prerequisites (PHP 8.4+, PostgreSQL 17, Redis, Docker)
...
- Domain modules (Auth, Shared, Address, Meter, Billing, Export)
...
- [ ] All code examples use PHP 8.4+ / Laravel 13 syntax
